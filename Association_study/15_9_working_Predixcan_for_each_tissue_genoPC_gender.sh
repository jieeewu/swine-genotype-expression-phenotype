...
mkdir -p ${Predixcan}/Predict_output ${Predixcan}/nqt_genoPC_gender_adjust_PrediXcanAssociation
...
--vcf_genotypes $Predixcan/${tissue}_80indivi_test_dataset_18295SNP_phased_for_Predixcan.vcf.gz \
--vcf_mode genotyped \
--prediction_output ${Predixcan}/Predict_output/${tissue}_18295SNP_predict_$cross.txt \
--prediction_summary_output ${Predixcan}/Predict_output/${tissue}_18295SNP_summary_$cross.txt \
--verbosity 9 \
--throw
